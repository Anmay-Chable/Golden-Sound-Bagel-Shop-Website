...
SECRET_KEY = 'django-insecure-b(^muqr*see2q%zq)@c6!sn*5u80%55e51t4)9n8-wx^&(2gb2'
...
INSTALLED_APPS = [
    ...
    'menu',  # Custom app for managing the bagel menu
]
...
ROOT_URLCONF = 'golden_sound_bagels.urls'
...
WSGI_APPLICATION = 'golden_sound_bagels.wsgi.application'
